...
function handSelection() {
    // po kliknięciu pokazuje się odpowiedni data (papier,kamień,nożyczki) => dataset.option
    game.playerHand = this.dataset.option
    // przed kliknieciem obramowanie powinno być usunięte ze wszystkichimg a nie tylko z jednego:
